          ...
          <div className="flex flex-wrap gap-3 mt-6 pt-6 border-t border-slate-200">
            {recommendation.website_url && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center h-12 px-8 bg-teal-600 text-white text-base font-semibold rounded-lg hover:bg-teal-700 hover:shadow-md active:bg-teal-800 motion-safe:active:scale-[0.98] transition-all duration-150"
              >
                Visit Website
            ...
            {recommendation.contact_info && (
              <a
                ...
                className="inline-flex items-center justify-center h-12 px-8 bg-white border border-slate-300 text-slate-700 text-base font-semibold rounded-lg hover:bg-slate-50 hover:shadow-md motion-safe:active:scale-[0.98] transition-all duration-150"
              >
